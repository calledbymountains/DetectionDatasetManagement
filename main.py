...
for subset in ['train', 'val']:
    ...
    reader.plot_annotations(df=df, plot_cols=['xmin', 'ymin', 'xmax', 'ymax', 'supercategory'])
...
for subset in ['10x-train', '1x-test']:
    db = CaltechPedestrian(name='caltech{}'.format(subset), base_dir=os.path.join(base_dir_caltech,'caltech{}'.format(subset)))
    db.writedataframe()
